...
export const siteConfig = {
  ...
  bio: [
    `Built by Saurav is a Delhi‑based digital studio with ${getExperience("2022-09-01")} of hands‑on experience. We specialise in Shopify theme development, React & Next.js apps, WordPress sites, and graphic design (logos, banners, social posts, video editing).`,
